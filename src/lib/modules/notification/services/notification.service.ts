...
export class NotificationService {
    ...
    //CRM Specific Change
    call_success(title: any = '', content: any = '', override?: any): Notification {
        return this.set({title: title, content: content || '', type: 'success', icon: this.icons.call, override: override}, true);
    }

    call_error(title: any = '', content: any = '', override?: any): Notification {
        return this.set({title: title, content: content || '', type: 'error', icon: this.icons.call, override: override}, true);
    }

    call_info(title: any = '', content: any = '', override?: any): Notification {
        return this.set({title: title, content: content || '', type: 'info', icon: this.icons.call, override: override}, true);
    }
