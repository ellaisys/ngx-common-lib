...
export interface INGXLoggerRulesService {
   ...
   * @param additional 
   */
  shouldCallWriter(level: LoggerLevel, config: INGXLoggerConfig, message?: any | (() => any), additional?: any[]): boolean;
  /**
   ...
   * @param additional 
   */
  shouldCallServer(level: LoggerLevel, config: INGXLoggerConfig, message?: any | (() => any), additional?: any[]): boolean;
  /**
   ...
   * @param additional 
   */
  shouldCallMonitor(level: LoggerLevel, config: INGXLoggerConfig, message?: any | (() => any), additional?: any[]): boolean;
}
