...
describe('NGXLoggerMetadataService', () => {
  ...
  describe('getMetadata', () => {
    it('should return good metadata', () => {
      ...
      const metadata = metadataService.getMetadata(LoggerLevel.ERROR, { level: LoggerLevel.ERROR }, 'test', []);

      expect(metadata.level).toEqual(LoggerLevel.ERROR);
    ...
    it('should call the function if the message is a function', () => {
      ...
      const metadata = metadataService.getMetadata(LoggerLevel.ERROR, { level: LoggerLevel.ERROR }, () => 'functest', []);
    ...
    it('should use the timestamp format if provided', () => {
      ...
      const metadata = metadataService.getMetadata(LoggerLevel.ERROR, { level: LoggerLevel.ERROR, timestampFormat: 'YYYY' }, 'test', []);
